...
/**
 * Interruptor de alternancia personalizado (on/off).
 * @component
 * @param {Object} props
 * @param {boolean} props.on - Estado actual del toggle.
 * @param {Function} props.onChange - Callback al pulsar.
 * @returns {JSX.Element}
 */
...
/**
 * Mensaje de error animado para campos de formulario.
 * @component
 * @param {Object} props
 * @param {string|undefined} props.msg - Texto del error; no renderiza si esta vacio.
...
/**
 * Devuelve la clase CSS del input segun su estado de validacion.
 * @param {boolean} hasError - Campo tiene error activo.
 * @param {boolean} touched - Campo fue tocado por el usuario.
 * @param {boolean} isDirty - Campo fue modificado.
 * @returns {string}
 */
...
/**
 * Pagina de perfil del usuario. Muestra avatar, datos, permisos por rol,
 * preferencias de idioma y tema, y ajustes de notificaciones.
 * Compone EditProfileCard y ChangePasswordCard para las acciones de edicion.
 * @component
 * @returns {JSX.Element}
 */
...
/**
 * Tarjeta de edicion de nombre y apellidos del usuario.
 * Alterna entre modo lectura y formulario con validacion Zod.
 * @component
 * @param {Object} props
 * @param {Object} props.user - Usuario autenticado del store.
 * @param {Function} props.updateUser - Accion del store para actualizar datos.
 * @param {boolean} props.editing - Si el formulario esta abierto.
 * @param {Function} props.setEditing - Controla modo edicion.
 * @param {string} props.msg - Mensaje de resultado ('ok' o texto de error).
 * @param {Function} props.setMsg - Actualiza el mensaje de resultado.
 * @param {Function} props.t - Funcion de traduccion.
 * @returns {JSX.Element}
 */
...
/**
 * Tarjeta de cambio de contraseña con validacion de fortaleza y confirmacion.
 * Maneja el error WRONG_CURRENT_PASSWORD por separado para mejorar UX.
 * @component
 * @param {Object} props
 * @param {boolean} props.editing - Si el formulario esta abierto.
 * @param {Function} props.setEditing - Controla modo edicion.
 * @param {string} props.msg - Mensaje de resultado.
 * @param {Function} props.setMsg - Actualiza el mensaje de resultado.
 * @param {Function} props.t - Funcion de traduccion.
 * @returns {JSX.Element}
 */
...
/**
 * Campo de contrasena con boton de visibilidad y estado de validacion visual.
 * @component
 * @param {Object} props
 * @param {string} props.label - Etiqueta del campo.
 * @param {boolean} props.show - Si la contrasena es visible en texto plano.
 * @param {Function} props.onToggle - Alterna visibilidad.
 * @param {Object} props.reg - Objeto de registro de react-hook-form.
 * @param {string|undefined} props.error - Mensaje de error.
 * @param {boolean} props.touched - Campo fue tocado.
 * @param {boolean} props.dirty - Campo fue modificado.
 * @returns {JSX.Element}
 */
