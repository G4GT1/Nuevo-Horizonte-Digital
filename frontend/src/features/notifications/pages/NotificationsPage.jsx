...
/**
 * Pagina de notificaciones con listado paginado, marcado individual/global y eliminacion.
 * El estilo visual de cada notificacion depende de su tipo via NOTIF_CONFIG.
 * @component
 * @returns {JSX.Element}
 */
