...
/**
 * Hook que crea el schema de validacion para el formulario de recuperacion.
 * @returns {import('zod').ZodObject} Schema con solo el campo email
 */
 ...
 * Pide el email del usuario y, si existe en el sistema, envia un enlace para restablecer la contrasena.
 * Tras el envio muestra una pantalla de confirmacion en lugar del formulario.
 * @component
 * @returns {JSX.Element}
 */
export default function ForgotPasswordPage() {
  ...
  /* sent se activa cuando el backend confirma el envio del email */
  ...
  /**
   * Llama al endpoint de recuperacion con el email del usuario.
   * @param {{ email: string }} data - Formulario validado por zod
   */
  ...
  /* Pantalla de confirmacion: se muestra cuando el email fue enviado correctamente */
  if (sent) {
    return (
      <motion.div
