...
/**
 * Mensaje de feedback inline (error o exito) con boton de cierre.
 * @component
 * @param {Object} props
 * @param {string} props.msg - Texto del mensaje; no renderiza si esta vacio.
 * @param {'error'|'success'} [props.type='error'] - Variante visual.
...
/**
 * Pagina de administracion de usuarios con tabla paginada, filtros de rol,
 * busqueda y acciones de editar, cambiar rol, suspender/reactivar y eliminar.
 * Tecnicos solo ven y gestionan usuarios con rol alumnado.
 * @component
 * @returns {JSX.Element}
 */
...
/**
 * Modal de edicion de datos de usuario (nombre, apellidos, email) con validacion Zod.
 * @component
 * @param {Object} props
 * @param {Object} props.user - Usuario a editar.
 * @param {Function} props.onClose - Callback al cerrar.
 * @param {Function} props.onSave - Callback al guardar; recibe (id, data).
 * @param {boolean} props.isPending - Si la mutacion de guardado esta en curso.
...
/**
 * Mensaje de error inline para un campo de formulario.
 * @param {Object} props
 * @param {string|undefined} props.msg - Texto del error.
 * @returns {JSX.Element|null}
 */
...
/**
 * Contenedor de modal con overlay de fondo, cabecera y area de contenido.
 * @component
 * @param {Object} props
