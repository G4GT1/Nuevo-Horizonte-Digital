...
/**
 * Pagina de gestion de invitaciones. Muestra tabla paginada con estado (pending/used/expired)
 * y permite crear nuevas invitaciones o eliminar existentes mediante modals.
 * @component
 * @returns {JSX.Element}
 */
...
/**
 * Modal de confirmacion para eliminar una invitacion pendiente.
 * @component
 * @param {Object} props
 * @param {Object} props.invitation - Objeto invitacion a eliminar.
 * @param {boolean} props.isPending - Si la mutacion de eliminacion esta en curso.
 * @param {Function} props.onConfirm - Callback al confirmar.
 * @param {Function} props.onClose - Callback al cancelar.
 * @returns {JSX.Element}
 */
...
/**
 * Modal de envio de invitacion por email con selector de rol y validacion Zod.
 * @component
 * @param {Object} props
 * @param {Function} props.onClose - Callback al cerrar.
 * @param {Function} props.onSuccess - Callback al enviar con exito; recibe el email como argumento.
 * @returns {JSX.Element}
 */
