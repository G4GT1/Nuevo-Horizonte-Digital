...
/**
 * Pagina de listado de estaciones con busqueda y filtro por fuente (FieldClimate/Cesens).
 * Muestra tarjetas con metricas actuales usando los slots de metaValores.
 * @component
 * @returns {JSX.Element}
 */
