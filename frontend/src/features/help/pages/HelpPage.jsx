...
/**
 * Tarjeta expandible de la guia de uso con icono, titulo, descripcion y detalle.
 * @component
 * @param {Object} props
 * @param {React.ElementType} props.icon - Icono Lucide.
 * @param {string} props.title - Titulo de la seccion.
 * @param {string} props.desc - Descripcion breve.
 * @param {string} props.detail - Texto adicional que aparece al expandir.
 * @returns {JSX.Element}
 */
...
/**
 * Fila acordeon de preguntas frecuentes.
 * @component
 * @param {Object} props
 * @param {string} props.q - Pregunta.
 * @param {string} props.a - Respuesta.
 * @returns {JSX.Element}
 */
...
/**
 * Pagina de ayuda con guia de uso, FAQs y formulario de ticket de soporte.
 * El contenido se filtra segun el rol del usuario (alumnado/tecnico/superadmin).
 * El ticket de soporte solo es visible para tecnicos y superadmins.
 * @component
 * @returns {JSX.Element}
 */
