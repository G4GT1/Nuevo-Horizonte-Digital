...
import { RoleBadge } from '@shared/components/layout/Sidebar';
...
/**
 * Encabezado de grupo dentro del desplegable de busqueda.
 * @component
 * @param {Object} props
 * @param {string} props.label - Texto del encabezado de seccion.
 * @param {React.ReactNode} props.children - Items de la seccion.
 * @returns {JSX.Element}
 */
...
/**
 * Fila seleccionable dentro del desplegable de busqueda.
 * @component
 * @param {Object} props
 * @param {React.ElementType} props.icon - Icono Lucide a mostrar.
 * @param {string} props.label - Texto principal del item.
 * @param {string} [props.badge] - Etiqueta secundaria (ej. fuente de estacion).
 * @param {Function} props.onClick - Callback al seleccionar el item.
 * @param {boolean} [props.accent=false] - Si true, aplica color primario al texto.
 * @returns {JSX.Element}
 */
...
/**
 * Campo de busqueda global con desplegable de paginas, estaciones y acciones rapidas.
 * Carga estaciones bajo demanda al abrir; filtra por rol y por query en tiempo real.
 * @component
 * @returns {JSX.Element}
 */
...
/**
 * Barra superior con busqueda global, selector de idioma, toggle de tema,
 * campana de notificaciones y avatar de usuario con insignia de rol.
 * @component
 * @returns {JSX.Element}
 */
