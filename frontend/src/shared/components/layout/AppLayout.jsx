...
/** Mapeo de rutas a claves de traduccion para el titulo del header. */
const routeTitles = {
...
/**
 * Toast global flotante que se muestra en la parte inferior de la pantalla.
 * Se auto-cierra a los 4 segundos. Usa el id del toast para re-animar
 * mensajes identicos consecutivos sin que AnimatePresence los ignore.
 * @component
 * @returns {JSX.Element}
 */
...
/**
 * Layout principal de la aplicacion para usuarios autenticados.
 * Monta el sidebar, el header, el area de contenido y el toast global.
 * Gestiona: sincronizacion del tema, refresco del token al entrar,
 * conteo de notificaciones no leidas y eventos WebSocket en tiempo real.
 * @component
 * @returns {JSX.Element}
 */
