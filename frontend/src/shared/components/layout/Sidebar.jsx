...
/**
 * Insignia de rol con animacion y tooltip descriptivo segun el rol del usuario.
 * @component
 * @param {Object} props
 * @param {'superadmin'|'tecnico'|'alumnado'} props.role - Rol del usuario.
 * @param {'sm'} [props.size='sm'] - Tamano (reservado para expansion futura).
...
/**
 * Barra lateral de navegacion con soporte de colapso animado.
 * Filtra items por rol, muestra seccion admin si aplica, y gestiona el logout.
 * @component
 * @returns {JSX.Element}
 */
